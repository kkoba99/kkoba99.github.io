...
#### I need to work on (and do) the following to improve my programming skills:
   ...
   Also, I need to read more about their rules and how they work in detail so that I can be more flexible when using them. In addition, I sometimes what certain programming 	jargon means, so I need to review those as well. 
